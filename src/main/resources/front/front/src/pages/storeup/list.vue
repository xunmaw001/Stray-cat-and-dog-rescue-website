...
<div :style='{"width":"100%","padding":"40px 7%","margin":"0 auto","position":"relative","background":"none"}'>
    ...
    <div v-if="storeupType==1" class="section-title" :style='{"margin":"10px 0","fontSize":"24px","lineHeight":"40px","color":"#333","textAlign":"center","background":"linear-gradient(180deg, rgba(255,255,255,1) 0%, rgba(240,240,240,1) 95%, rgba(189,189,189,1) 100%)"}'>我的收藏</div>
