...
<div>
    ...
    <el-form :inline="true" :model="formSearch" class="list-form-pv" :style='{"padding":"10px","margin":"40px 0 0","alignItems":"center","flexWrap":"wrap","textAlign":"center","background":"#f5f5f5","display":"flex","width":"100%","height":"auto"}'>
      ...
      <el-form-item :style='{"alignItems":"center","margin":"0 4px 0 0","display":"flex"}'>
		<div class="lable" v-if="true" :style='{"width":"auto","padding":"0 10px","lineHeight":"42px","display":"inline-block"}'>活动分类</div>
        <el-select v-model="formSearch.huodongfenlei" placeholder="请选择活动分类" :clearable="true">
          <el-option v-for="(item, index) in huodongfenleiOptions" :key="index" :label="item" :value="item"></el-option>
        </el-select>
      </el-form-item>
      <el-form-item :style='{"alignItems":"center","margin":"0 4px 0 0","display":"flex"}'>
	    <div class="lable" v-if="true" :style='{"width":"auto","padding":"0 10px","lineHeight":"42px","display":"inline-block"}'>活动地址</div>
        <el-input v-model="formSearch.huodongdizhi" placeholder="活动地址" clearable></el-input>
      </el-form-item>
      <el-form-item :style='{"alignItems":"center","margin":"0 4px 0 0","display":"flex"}'>
	  ...
	  <el-button v-if="isAuth('huodongxinxi','新增')" :style='{"cursor":"pointer","border":"0","padding":"0px 10px","margin":"0 10px 0 0","color":"#fff","minWidth":"90px","outline":"none","borderRadius":"0","background":"#9f9fd7","width":"auto","fontSize":"14px","lineHeight":"42px","height":"42px"}' type="primary" @click="add('/index/huodongxinxiAdd')"><i v-if="true" :style='{"color":"#fff","margin":"0 10px 0 0","fontSize":"14px"}' class="el-icon-circle-plus-outline"></i>添加</el-button>
    </el-form>
	...
	<div class="list" :style='{"padding":"20px 7% 20px 7%","margin":"20px 0 10px","background":"none","flex":"1","width":"100%","minWidth":"900px","order":"3"}'>
		...
		<div class="list1 index-pv1" :style='{"padding":"0 0 0 3%","margin":"30px 0 0","overflow":"hidden","flexWrap":"wrap","background":"none","display":"flex","width":"100%","height":"auto"}'>
			<div :style='{"cursor":"pointer","margin":"0 3% 10% 0","flexWrap":"wrap","background":"none","display":"flex","width":"30%","position":"relative","justifyContent":"space-between","height":"auto"}' v-for="(item, index) in dataList" :key="index" @click="toDetail(item)" class="list-item animation-box">
				<img :style='{"padding":"20px 10px","margin":"0 0 12px","objectFit":"contain","borderRadius":"8px","background":"url(http://codegen.caihongy.cn/20230129/b183ae010bb2489e8747e9baffeed40f.png) no-repeat center top / 100% 100%","display":"block","width":"100%","height":"260px"}' v-if="item.huodongtupian && item.huodongtupian.substr(0,4)=='http'" :src="item.huodongtupian" class="image" />
				<img :style='{"padding":"20px 10px","margin":"0 0 12px","objectFit":"contain","borderRadius":"8px","background":"url(http://codegen.caihongy.cn/20230129/b183ae010bb2489e8747e9baffeed40f.png) no-repeat center top / 100% 100%","display":"block","width":"100%","height":"260px"}' v-else :src="baseUrl + (item.huodongtupian?item.huodongtupian.split(',')[0]:'')" class="image" />
				...
				<div :style='{"padding":"4px 0","whiteSpace":"nowrap","overflow":"hidden","color":"#333","textAlign":"center","background":"#efeffd","width":"100%","lineHeight":"30px","fontSize":"14px","textOverflow":"ellipsis"}' class="name ">{{item.huodongmingcheng}}</div>
				<div :style='{"padding":"4px 0","whiteSpace":"nowrap","overflow":"hidden","color":"#333","textAlign":"center","background":"#efeffd","width":"100%","lineHeight":"30px","fontSize":"14px","textOverflow":"ellipsis"}' class="name ">{{item.huodongfenlei}}</div>
				<div :style='{"padding":"4px 0","whiteSpace":"nowrap","overflow":"hidden","color":"#333","textAlign":"center","background":"#efeffd","width":"100%","lineHeight":"30px","fontSize":"14px","textOverflow":"ellipsis"}' class="name ">{{item.huodongdizhi}}</div>
			</div>
		</div>
...
<script>
  export default {
    ...
    created() {
      ...
      this.$http.get('option/huodongfenlei/huodongfenlei').then(res => {
        if (res.data.code == 0) {
